<div>
    <input type="file" name="files[]" wire:model="images" accept=".jpg, .jpeg, .png" id="file-input" multiple class="block p-2 text-sm border rounded-lg cursor-pointer text-gray-400 focus:outline-none bg-gray-700 border-gray-600 placeholder-gray-400 my-2">
